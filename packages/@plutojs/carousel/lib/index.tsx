...
export default class extends Component<PropsType, StateType> {
  ...
  componentDidMount() {
    ...
    this.componentObj.addEventListener('touchmove', (e: TouchEvent) => {
      const { clientX } = e.targetTouches[0];
  ...
  render(): React.ReactNode {
    return (
      <div className={`${style.carouselContainer}`} ref={item => { this.componentObj = item; }}>
        <Carousel
          selectedItem={this.props.selectedItem}
          showArrows={this.props.showArrows}
          showStatus={this.props.showStatus}
          showThumbs={this.props.showThumbs}
          showIndicators={this.props.showIndicators && this.props.children.length > 1}
